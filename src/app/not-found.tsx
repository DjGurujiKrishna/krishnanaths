...
export default function NotFound() {
  return (
    <PageShell className="min-h-screen bg-gradient-to-b from-black to-gray-900 flex justify-center items-center relative overflow-hidden">
      ...
      <div
        className="text-center relative z-10 backdrop-blur-sm bg-black/10 p-12 rounded-xl border border-yellow-700/20 shadow-lg transform hover:scale-105 transition-all duration-500"
        data-aos="zoom-out"
      >
        <motion.h2
